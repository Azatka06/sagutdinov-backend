...
class ApplicationTest {
    ...
    private val configure: Application.() -> Unit = {
        (environment.config as MapApplicationConfig).apply {
            ...
            put("sagutdinov.fcm.password", "TEST_FCM_PASSWORD")
            put("sagutdinov.fcm.salt", "TEST_FCM_SALT")
            put("sagutdinov.fcm.db-url", "TEST_FCM_DB_URL")
            put("sagutdinov.fcm.path", "./fcm/fcm-encrypted.json")
        }
        module(testing = true)
    }
